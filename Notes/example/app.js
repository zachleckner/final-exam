...
app.post('/login', (req, res) => {
    // Assuming the user data is available in req.body
    const { username, gNumber, email } = req.body;
    
    // Set cookie with user data
    res.cookie('userData', { username, gNumber, email });
    
    // Redirect to page2 or any other page
    res.redirect('/page2');
});
